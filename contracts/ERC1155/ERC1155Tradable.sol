  ...
  /**
    ...
    */
    function create(
        ...
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC1155PresetMinterPauser: must have minter role to create");
    ...
    function _burn(
        ...
        require(hasRole(BURNER_ROLE, _msgSender()), "ERC1155PresetMinterPauser: must have minter role to burn");
